...
var M = Math.pow,
	...
	Y = (f, r) => {
		for (var c in r || (r = {})) qe.call(r, c) && xe(f, c, r[c])
		if (Pe) for (var c of Pe(r)) ut.call(r, c) && xe(f, c, r[c])
		return f
	},
	ae = (f, r) => it(f, ot(r))
var lt = (f, r) => {
	...
	at = (f, r, c, u) => {
		if ((r && typeof r == 'object') || typeof r == 'function')
			for (let a of st(r))
				!qe.call(f, a) &&
					a !== c &&
					de(f, a, { get: () => r[a], enumerable: !(u = nt(r, a)) || u.enumerable })
		return f
	}
var ft = (f) => at(de({}, '__esModule', { value: !0 }), f)
var Q = (f, r, c) => (xe(f, typeof r != 'symbol' ? r + '' : r, c), c)
var fe = (f, r, c) =>
	new Promise((u, a) => {
		var d = (m) => {
				try {
...
var At = {}
lt(At, { CSVParser: () => ye, default: () => Nt })
module.exports = ft(At)
var ce = {},
	Ve = !1
function ct() {
	if (Ve) return ce
	;(Ve = !0), (ce.byteLength = p), (ce.toByteArray = w), (ce.fromByteArray = N)
	for (
		var f = [],
			r = [],
	...
	function w(_) {
		...
		for (L = 0; L < U; L += 4)
			(E =
				(r[_.charCodeAt(L)] << 18) |
				(r[_.charCodeAt(L + 1)] << 12) |
				(r[_.charCodeAt(L + 2)] << 6) |
				r[_.charCodeAt(L + 3)]),
				(S[O++] = (E >> 16) & 255),
				(S[O++] = (E >> 8) & 255),
				(S[O++] = E & 255)
		return (
			T === 2 &&
				((E = (r[_.charCodeAt(L)] << 2) | (r[_.charCodeAt(L + 1)] >> 4)), (S[O++] = E & 255)),
			T === 1 &&
				((E =
					(r[_.charCodeAt(L)] << 10) |
					(r[_.charCodeAt(L + 1)] << 4) |
					(r[_.charCodeAt(L + 2)] >> 2)),
				(S[O++] = (E >> 8) & 255),
				(S[O++] = E & 255)),
			S
		)
	...
	function g(_, E, b) {
		for (var B, T = [], S = E; S < b; S += 3)
			(B = ((_[S] << 16) & 16711680) + ((_[S + 1] << 8) & 65280) + (_[S + 2] & 255)), T.push(I(B))
		return T.join('')
	}
	function N(_) {
		for (var E, b = _.length, B = b % 3, T = [], S = 16383, O = 0, U = b - B; O < U; O += S)
			T.push(g(_, O, O + S > U ? U : O + S))
		return (
			B === 1
				? ((E = _[b - 1]), T.push(f[E >> 2] + f[(E << 4) & 63] + '=='))
				: B === 2 &&
				  ((E = (_[b - 2] << 8) + _[b - 1]),
				  T.push(f[E >> 10] + f[(E >> 4) & 63] + f[(E << 2) & 63] + '=')),
			T.join('')
		)
	}
	return ce
	...
	return (
		(pe.read = function (f, r, c, u, a) {
			var d,
				...
				_ = f[r + g]
			for (
				g += N, d = _ & ((1 << -I) - 1), _ >>= -I, I += p;
				I > 0;
				d = d * 256 + f[r + g], g += N, I -= 8
			);
			for (
				o = d & ((1 << -I) - 1), d >>= -I, I += u;
				I > 0;
				o = o * 256 + f[r + g], g += N, I -= 8
			);
			if (d === 0) d = 1 - w
			else {
				...
				r = Math.abs(r),
					isNaN(r) || r === 1 / 0
						...
						: ((o = Math.floor(Math.log(r) / Math.LN2)),
						  ...
						  o + g >= 1 ? (r += N / m) : (r += N * Math.pow(2, 1 - g)),
						  r * m >= 2 && (o++, (m /= 2)),
						  o + g >= I
								? ((p = 0), (o = I))
								: o + g >= 1
								? ((p = (r * m - 1) * Math.pow(2, a)), (o = o + g))
								: ((p = r * Math.pow(2, g - 1) * Math.pow(2, a)), (o = 0)));
				a >= 8;
				f[c + _] = p & 255, _ += E, p /= 256, a -= 8
			);
			for (o = (o << a) | p, w += a; w > 0; f[c + _] = o & 255, _ += E, o /= 256, w -= 8);
			f[c + _ - E] |= b * 128
		}),
		pe
	)
...
function dt() {
	...
	let f = ct(),
		...
		c =
			typeof Symbol == 'function' && typeof Symbol.for == 'function'
				...
				: null
	;(ee.Buffer = o), (ee.SlowBuffer = T), (ee.INSPECT_MAX_BYTES = 50)
	let u = 2147483647
	;(ee.kMaxLength = u),
	...
	function b(i) {
		...
		if (i.length !== void 0) return typeof i.length != 'number' || Oe(i.length) ? d(0) : N(i)
	...
	;(o.isBuffer = function (e) {
		...
		(o.compare = function (e, t) {
			...
			let n = e.length,
				s = t.length
			for (let l = 0, h = Math.min(n, s); l < h; ++l)
				if (e[l] !== t[l]) {
					;(n = e[l]), (s = t[l])
					break
				}
		...
		(o.concat = function (e, t) {
			...
			for (n = 0; n < e.length; ++n) {
				...
				if (z(h, Uint8Array))
					l + h.length > s.length
						? (o.isBuffer(h) || (h = o.from(h)), h.copy(s, l))
						: Uint8Array.prototype.set.call(s, h, l)
				else if (o.isBuffer(h)) h.copy(s, l)
		...
		if (s) {
			...
			for (k = t; k < h; k++)
				if (q(i, k) === q(e, V === -1 ? 0 : k - V)) {
					if ((V === -1 && (V = k), k - V + 1 === A)) return V * l
				} else V !== -1 && (k -= k - V), (V = -1)
		} else
			for (t + A > h && (t = h - A), k = t; k >= 0; k--) {
				let V = !0
				for (let $ = 0; $ < A; $++)
					if (q(i, k + $) !== q(e, $)) {
						V = !1
	...
	function we(i, e, t, n) {
		...
		let h
		for (h = 0; h < n; ++h) {
			let A = parseInt(e.substr(h * 2, 2), 16)
			if (Oe(A)) return h
			i[t + h] = A
		}
		return h
	...
	function H(i) {
		let e = i.length
		if (e <= P) return String.fromCharCode.apply(String, i)
		let t = '',
			n = 0
		for (; n < e; ) t += String.fromCharCode.apply(String, i.slice(n, (n += P)))
		return t
	}
	function Ee(i, e, t) {
		let n = ''
	...
	;(o.prototype.readUintLE = o.prototype.readUIntLE =
		...
		(o.prototype.readBigUInt64LE = X(function (e) {
			...
			let s = t + this[++e] * M(2, 8) + this[++e] * M(2, 16) + this[++e] * M(2, 24),
				l = this[++e] + this[++e] * M(2, 8) + this[++e] * M(2, 16) + n * M(2, 24)
		...
		(o.prototype.readBigUInt64BE = X(function (e) {
			...
			let t = this[e],
				n = this[e + 7]
			;(t === void 0 || n === void 0) && le(e, this.length - 8)
			let s = t * M(2, 24) + this[++e] * M(2, 16) + this[++e] * M(2, 8) + this[++e],
				l = this[++e] * M(2, 24) + this[++e] * M(2, 16) + this[++e] * M(2, 8) + n
		...
		(o.prototype.readBigInt64LE = X(function (e) {
			...
			let t = this[e],
				n = this[e + 7]
			;(t === void 0 || n === void 0) && le(e, this.length - 8)
			let s = this[e + 4] + this[e + 5] * M(2, 8) + this[e + 6] * M(2, 16) + (n << 24)
			return (
				(BigInt(s) << BigInt(32)) +
				BigInt(t + this[++e] * M(2, 8) + this[++e] * M(2, 16) + this[++e] * M(2, 24))
			)
		})),
		(o.prototype.readBigInt64BE = X(function (e) {
			...
			let t = this[e],
				n = this[e + 7]
			;(t === void 0 || n === void 0) && le(e, this.length - 8)
			let s = (t << 24) + this[++e] * M(2, 16) + this[++e] * M(2, 8) + this[++e]
			return (
				(BigInt(s) << BigInt(32)) +
				BigInt(this[++e] * M(2, 24) + this[++e] * M(2, 16) + this[++e] * M(2, 8) + n)
			)
		})),
	...
	;(o.prototype.writeUintLE = o.prototype.writeUIntLE =
		function (e, t, n, s) {
			...
			let l = 1,
				h = 0
			for (this[t] = e & 255; ++h < n && (l *= 256); ) this[t + h] = (e / l) & 255
			return t + n
		}),
		(o.prototype.writeUintBE = o.prototype.writeUIntBE =
			function (e, t, n, s) {
				...
				let l = n - 1,
					h = 1
				for (this[t + l] = e & 255; --l >= 0 && (h *= 256); ) this[t + l] = (e / h) & 255
				return t + n
			}),
		(o.prototype.writeUint8 = o.prototype.writeUInt8 =
			function (e, t, n) {
				return (e = +e), (t = t >>> 0), n || F(this, e, t, 1, 255, 0), (this[t] = e & 255), t + 1
			}),
	...
	function Ue(i, e, t, n, s, l) {
		if (t + n > i.length) throw new RangeError('Index out of range')
		if (t < 0) throw new RangeError('Index out of range')
	}
	function Le(i, e, t, n, s) {
		return (e = +e), (t = t >>> 0), s || Ue(i, e, t, 4), r.write(i, e, t, n, 23, 4), t + 4
	}
	...
	function De(i, e, t, n, s) {
		return (e = +e), (t = t >>> 0), s || Ue(i, e, t, 8), r.write(i, e, t, n, 52, 8), t + 8
	}
	;(o.prototype.writeDoubleLE = function (e, t, n) {
		...
		(o.prototype.fill = function (e, t, n, s) {
			...
			if (typeof e == 'number') for (l = t; l < n; ++l) this[l] = e
				...
				for (l = 0; l < n - t; ++l) this[l + t] = h[l % A]
			}
			return this
		})
	let ne = {}
		...
		Be(
			...
			function (i, e, t) {
				let n = `The value of "${i}" is out of range.`,
					s = t
				return (
					Number.isInteger(t) && Math.abs(t) > M(2, 32)
						? (s = $e(String(t)))
						: typeof t == 'bigint' &&
						  ((s = String(t)),
						  (t > M(BigInt(2), BigInt(32)) || t < -M(BigInt(2), BigInt(32))) && (s = $e(s)),
						  (s += 'n')),
	...
	function We(i, e, t) {
		oe(e, 'offset'), (i[e] === void 0 || i[e + t] === void 0) && le(e, i.length - (t + 1))
	}
	function Me(i, e, t, n, s, l) {
		if (i > t || i < e) {
			...
			throw (
				(l > 3
					? e === 0 || e === BigInt(0)
						? (A = `>= 0${h} and < 2${h} ** ${(l + 1) * 8}${h}`)
						: (A = `>= -(2${h} ** ${(l + 1) * 8 - 1}${h}) and < 2 ** ${(l + 1) * 8 - 1}${h}`)
					: (A = `>= ${e}${h} and <= ${t}${h}`),
				new ne.ERR_OUT_OF_RANGE('value', A, i))
			)
		}
		We(n, s, l)
	}
	...
	function et(i, e) {
		...
		for (let h = 0; h < i.length && !((e -= 2) < 0); ++h)
			(t = i.charCodeAt(h)), (n = t >> 8), (s = t % 256), l.push(s), l.push(n)
		return l
	}
	function ke(i) {
		return f.toByteArray(Ze(i))
	}
	function he(i, e, t, n) {
		let s
...
te.kMaxLength
var y = te.Buffer,
	Rt = te.INSPECT_MAX_BYTES,
	Ut = te.kMaxLength
var C = class f extends Error {
	constructor(r, c, u, ...a) {
...
var me = function (f) {
	...
	for (let c = 0, u = f.length; c < u; c++) {
		let a = f[c]
		if (a == null || a === !1) r[c] = { disabled: !0 }
		else if (typeof a == 'string') r[c] = { name: a }
		else if (Je(a)) {
			...
			throw new C('CSV_INVALID_COLUMN_DEFINITION', [
				...
				`got ${JSON.stringify(a)} at position ${c}`
			])
	}
	return r
}
...
var ze = function (f) {
	...
	Qe = function (f = {}) {
		...
		return {
			...
			options: c,
			state: je(c),
			__needMoreData: function (u, a, d) {
				if (d) return !1
				let { encoding: o, escape: p, quote: m } = this.options,
					{ quoting: w, needMoreDataSize: I, recordDelimiterMaxLength: g } = this.state,
					N = a - u - 1,
					_ = Math.max(
						I,
						g === 0
...
`,
			...
			parse: function (u, a, d, o) {
				let {
					...
					{ comment: O, escape: U, quote: L, record_delimiter: re } = this.options,
					{ bomSkipped: we, previousBuf: ie, rawBuffer: Ie, escapeIsQuote: be } = this.state,
					R
				if (ie === void 0)
					if (u === void 0) {
						o()
				...
				if (we === !1)
					if (p === !1) this.state.bomSkipped = !0
						...
						for (let P in se)
							if (se[P].compare(R, 0, se[P].length) === 0) {
								let H = se[P].length
								;(this.state.bufBytesStart += H),
									(R = R.slice(H)),
									(this.options = Te(ae(Y({}, this.original_options), { encoding: P }))),
				...
				let ue = R.length,
					x
				for (x = 0; x < ue && !this.__needMoreData(x, ue, a); x++) {
					if (
					...
					if (
						...
						if (this.state.commenting === !1 && this.__isQuote(R, x))
							if (this.state.quoting === !0) {
								let v = R[x + L.length],
									K = b && this.__isCharTrimable(R, x + L.length),
									G = O !== null && this.__compareBytes(O, R, x + L.length, v),
									D = this.__isDelimiter(R, x + L.length, v),
									F =
										re.length === 0
											? this.__autoDiscoverRecordDelimiter(R, x + L.length)
											: this.__isRecordDelimiter(v, R, x + L.length)
								if (U !== null && this.__isEscape(R, x, P) && this.__isQuote(R, x + U.length))
									x += U.length - 1
								else if (!v || D || F || G || K) {
								...
								if (E === !1) {
									let v = this.__infoField(),
										K = Object.keys(se)
											.map((D) => (se[D].equals(this.state.field.toString()) ? D : !1))
											.filter(Boolean)[0],
										G = this.__error(
											new C(
						...
						if (this.state.quoting === !1) {
							let v = this.__isRecordDelimiter(P, R, x)
							if (v !== 0) {
								if (
									...
									if (
										...
										this.info.empty_lines++, (x += v - 1)
										continue
									}
									this.info.bytes = this.state.bufBytesStart + x
									let F = this.__onField()
									if (F !== void 0) return F
									this.info.bytes = this.state.bufBytesStart + x + v
								...
								;(this.state.commenting = !1), (x += v - 1)
								continue
							}
							if (this.state.commenting) continue
							if (
								(O === null ? 0 : this.__compareBytes(O, R, x, P)) !== 0 &&
								(m === !1 || this.state.field.length === 0)
							) {
								this.state.commenting = !0
								continue
							}
							let G = this.__isDelimiter(R, x, P)
							if (G !== 0) {
								this.info.bytes = this.state.bufBytesStart + x
					...
					let H =
						...
						Ee = b === !1 || this.state.wasQuoting === !1
					if (H === !0 && Ee === !0) this.state.field.append(P)
					else {
						...
						H === !1 && (x += this.__isCharTrimable(R, x) - 1)
						continue
					}
				}
				if (a === !0)
			...
			__firstLineToColumns: function (u) {
				...
				try {
					let d = a === void 0 ? u : a.call(null, u)
					if (!Array.isArray(d))
						return this.__error(
							new C(
			...
			__onField: function () {
				let { cast: u, encoding: a, rtrim: d, max_record_size: o } = this.options,
			...
			__cast: function (u) {
				let { columns: a, relax_column_count: d } = this.options
				if (Array.isArray(a) === !0 && d && this.options.columns.length <= this.state.record.length)
			...
			__isCharTrimable: function (u, a) {
				return ((o, p) => {
					...
					e: for (let w = 0; w < m.length; w++) {
						let I = m[w]
						for (let g = 0; g < I.length; g++) if (I[g] !== o[p + g]) continue e
						return I.length
					}
					return 0
				})(u, a)
			...
			__compareBytes: function (u, a, d, o) {
				if (u[0] !== o) return 0
				let p = u.length
				for (let m = 1; m < p; m++) if (u[m] !== a[d + m]) return 0
				return p
			},
			__isDelimiter: function (u, a, d) {
			...
			__isRecordDelimiter: function (u, a, d) {
				...
				e: for (let m = 0; m < p; m++) {
					let w = o[m],
						I = w.length
					if (w[0] === u) {
						for (let g = 1; g < I; g++) if (w[g] !== a[d + g]) continue e
						return w.length
					}
				}
				return 0
			},
			__isEscape: function (u, a, d) {
				let { escape: o } = this.options
				if (o === null) return !1
				let p = o.length
				if (o[0] === d) {
					for (let m = 0; m < p; m++) if (o[m] !== u[a + m]) return !1
					return !0
				}
				return !1
			},
			__isQuote: function (u, a) {
				...
				if (d === null) return !1
				let o = d.length
				for (let p = 0; p < o; p++) if (d[p] !== u[a + p]) return !1
				return !0
			},
...
`,
				...
				e: for (let p = 0; p < o.length; p++) {
					let m = o[p].length
					for (let w = 0; w < m; w++) if (o[p][w] !== u[a + w]) continue e
					return (
			...
			__error: function (u) {
				let { encoding: a, raw: d, skip_records_with_error: o } = this.options,
					p = typeof u == 'string' ? new Error(u) : u
				if (o) {
					;(this.state.recordHasError = !0),
						this.options.on_skip !== void 0 &&
							this.options.on_skip(p, d ? this.state.rawBuffer.toString(a) : void 0)
					return
				} else return p
			},
			__infoDataSet: function () {
				return ae(Y({}, this.info), { columns: this.options.columns })
			},
			__infoRecord: function () {
				let { columns: u, raw: a, encoding: d } = this.options
				return ae(Y({}, this.__infoDataSet()), {
					error: this.state.error,
					header: u === !0,
					index: this.state.record.length,
					raw: a ? this.state.rawBuffer.toString(d) : void 0
				})
			},
			__infoField: function () {
				let { columns: u } = this.options,
					a = Array.isArray(u)
				return ae(Y({}, this.__infoRecord()), {
					column:
						a === !0
...
var Z = {
	...
	xt = (f, r) => {
		let c = r.length > 0 ? f.map((u) => u.filter((a, d) => !r.includes(d))) : f
		return c.map((u, a) =>
			u.map((d, o) => {
				let p = Ce(d)
				return p === 'undefined' && a > 0 ? Ce(c[a - 1][o]) : p
			})
		)
	},
	Ge = (f, r = ',') => {
		...
		let d = u.filter((B) => B && B !== null && B !== ''),
			...
			p = 0,
			m = Et(d)
		o.push(m * (Z.uniqueHeaderProbalility | 1)), (p += Z.uniqueHeaderProbalility | 1)
		let w = d.map((B) => Ce(B)),
			I = w.filter((B) => B !== 'undefined'),
			g = Bt(I.length > 0 ? I : w)
		o.push(g * (Z.headerTypesProbability | 1)), (p += Z.headerTypesProbability | 1)
		let N = c[0].map((B, T) => c.map((S) => S[T])),
			_ = St(N, u)
		o.push(_ * (Z.headerFrequencyProbability | 1)), (p += Z.headerFrequencyProbability | 1)
		let E = xt(c, a),
			b = Ot(E, w)
		return (
			o.push(b * (Z.dataTypesDifference | 1)),
			(p += Z.dataTypesDifference | 1),
...
var Ye = (f) => {
	...
	c.forEach((g) => {
		u.forEach((N) => {
			let _ = g.split(N).length
			_ !== 1 && (a[N] || ((a[N] = 0), (d[N] = [])), (a[N] += _ - 1), d[N].push(_ - 1))
		})
	})
	let o = Object.keys(a)
...
var ge = class {
	constructor() {
		Q(this, '_data', null)
		Q(this, '_headers', null)
		Q(this, '_autoheader', !0)
		Q(this, '_isHeader', !0)
		Q(this, '_hasHeader', !1)
		Q(this, '_emptyColumnPrefix', 'Column')
		Q(this, '_probabilityVariable', 0.5)
		Q(this, 'parserOptions', { encoding: 'utf-8' })
		Q(this, 'meta', { name: 'csvParser' })
	}
	get hasHeader() {
					...
					(r, c) =>
						fe(this, null, function* () {
							...
							for (let { target: u } of r.target) {
								...
								let d = yield this.parse(a.url || a.content || '')
	...
	parse(u) {
		return fe(this, arguments, function* (r, c = {}) {
			return r
	...
	getDelimiter(r) {
		var c
		return ((c = this.parserOptions.delimiter) == null ? void 0 : c.toString()) || Ye(r)
	}
	_buildData(r) {
		...
		for (let a = 0; a < r[0].length; a++) {
			let d = (c[a].length > 0 && c[a]) || this._emptyColumnPrefix + (a + 1)
			u.push({ name: d.trim(), values: r.map((o) => o[a] || '') })
		}
		return { series: u }
	}
	_getHeader(r) {
		...
		return this._isHeader &&
			...
			? c.map((a, d) => (a.length === 0 ? this._emptyColumnPrefix + (d + 1) : a))
			: Object.keys(r[0]).map((a) => this._emptyColumnPrefix + (parseInt(a) + 1))
	}
}
